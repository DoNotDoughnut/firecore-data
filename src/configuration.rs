...
pub struct Configuration {
	...
	pub controls: HashMap<Control, firecore_input::KeySetSerializable>,	
...
impl Configuration {
	...
	pub fn on_reload(&self) {
		...
		*firecore_input::keyboard::KEY_CONTROLS.write() = firecore_input::keyboard::serialization::normal_map(&self.controls);
